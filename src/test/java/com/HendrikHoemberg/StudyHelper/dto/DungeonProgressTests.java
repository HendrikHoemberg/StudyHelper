...
class DungeonProgressTests {
    ...
    private DungeonProgress zero() {
        return new DungeonProgress(0, 0, 0, 0, 0, 0, 0);
    }
    ...
    void recordAnswer_correctAfterStreak_preservesLongest() {
        DungeonProgress p = new DungeonProgress(2, 2, 2, 4, 0, 0, 0).recordAnswer(true);
    ...
    void recordAnswer_wrong_incrementsAnsweredAndResetsStreakKeepingLongest() {
        DungeonProgress p = new DungeonProgress(5, 4, 3, 5, 0, 0, 0).recordAnswer(false);
    ...
    void recordShieldUsed_increments() {
        ...
        assertThat(new DungeonProgress(0,0,0,0,0,3,0).recordShieldUsed().shieldsUsed()).isEqualTo(4);
    }
